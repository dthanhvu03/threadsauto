...
const radioClasses = computed(() => {
  // Radio size: Mobile 20px (touch area 44px), Tablet 18px, Desktop 16px
  const base = 'h-5 w-5 md:h-[18px] md:w-[18px] lg:h-4 lg:w-4 text-primary-600 focus:ring-primary-500 border-gray-300 transition-colors cursor-pointer'
